        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            ...
            <h1 className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>
              Find Your<br /> <span> Potential Value With</span> <br /> Professor BigHead Class!
            </h1>
            <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure itaque numquam dolorem, non suscipit sed!</p>
            <button className='btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s' onClick={() => navigate("/kelas")}>Explore Class</button>
            <button className='btn btn-outline-danger btn-lg rounded-1 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s'>Get Promo!</button>
            </Col>
